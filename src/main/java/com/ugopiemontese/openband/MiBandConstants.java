...
public class MiBandConstants
{
    ...
    public static final String PREFERENCE_GENDER = "sex";

    public static final String PREFERENCE_AGE = "age";

    public static final String PREFERENCE_GOAL = "goal";

    public static final String PREFERENCE_FIRMWARE = "firmware";

    public static final String PREFERENCE_MAC_ADDRESS = "mac_address";
