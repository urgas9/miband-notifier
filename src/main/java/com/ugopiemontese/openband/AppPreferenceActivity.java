	...
	@Override protected void onCreate(Bundle savedInstanceState)
	{
		...
		findViewById(R.id.startTimeTextField).setOnClickListener(new View.OnClickListener()
		{
			@Override public void onClick(final View v)
			{
				...
				}, mApplication.getmStartPeriodCalendar().get(Calendar.HOUR_OF_DAY), mApplication.getmStartPeriodCalendar().get(Calendar.MINUTE), true);
				dialog.show();
			}
		});
		...
		findViewById(R.id.endTimeTextField).setOnClickListener(new View.OnClickListener()
		{
			@Override public void onClick(final View v)
			{
				...
				}, mApplication.getmEndPeriodCalendar().get(Calendar.HOUR_OF_DAY), mApplication.getmEndPeriodCalendar().get(Calendar.MINUTE), true);
				dialog.show();
			}
		});
