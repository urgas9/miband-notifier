...
import com.ugopiemontese.openband.BLECommunicationManager;
import com.ugopiemontese.openband.MiBandConnectFailureException;
			...
			try
			{
				...
				for(BLEAction action : actions)
				{
					...
					else if(action instanceof WriteAction)
					{
						try
						{
                            bleCommunicationManager.setUserInfo();
